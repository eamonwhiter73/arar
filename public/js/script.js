...
function callback(results, status) {
  if (status == google.maps.places.PlacesServiceStatus.OK) {
    ...
    geoHash = Geohash.encode(42.24682749999999, -71.17473089999997);
    var obj = {name: "home"};
    obj['rating'] = 5;

    updates["locations/" + "ChIJpd7tz5B_44kRfvSIyNDxpMo"] = obj;
    updates["location_coord/" + "ChIJpd7tz5B_44kRfvSIyNDxpMo" + "/g"] = geoHash;
    updates["location_coord/" + "ChIJpd7tz5B_44kRfvSIyNDxpMo" + "/l"] = new Array(42.24682749999999, -71.17523089999997);
    ...
    for (var i = 1; i < 5; i++) {
      ...
      var starting_lon_var = -71.17523089999997 + constant_lon * (i * Math.random());
      ...
      starting_lon_var = -71.17523089999997 - constant_lon * (i * Math.random());
      ...
      geoHash = Geohash.encode(starting_lat_var, -71.17523089999997);
      updates["ships_for_locations/" + "ChIJpd7tz5B_44kRfvSIyNDxpMo" + "/ship" + counter.toString() + "/g"] = geoHash;
      updates["ships_for_locations/" + "ChIJpd7tz5B_44kRfvSIyNDxpMo" + "/ship" + counter.toString() + "/l"] = new Array(starting_lat_var, -71.17523089999997);
      counter+=1;
